...
class CR(nn.Module):
    def __init__(self,chin,chout,kernel_size,stride=1,padding=None,bias=True,dcn_conv=False):
...
class FPNExtractor(nn.Module):
    def __init__(self,c3,c4,c5,inner_channel=256,bias=True):
        ...
        # note: paper says f6,f7 are produced by f5,f6, but codes here are different
