...
class FCOSHead(nn.Module):
    def __init__(self,in_channel=256,
        ...
        self.grids=[torch.zeros(size=(0,4))]*5   # len = num of predict layers
    ...
    def build_grids(self,feature_maps):
        ...
        assert len(feature_maps)==self.layer_num
    ...
    def forward(self,xs):
        ...
        if self.training:
            ...
            bs=xs[0].shape[0]
            output=list()
            for cls_predict,reg_predict,center_predict,grid in zip(cls_outputs,reg_outputs,center_outputs,self.grids):
...
class FCOS(nn.Module):
    def __init__(self,
        ...
        self.head=FCOSHead(256,256,4,num_cls,strides)
