...
def valid_model():
    ...
    predict_list = list()
    target_list = list()
    vdata = COCODataSets(img_root="/home/wrc/wangchao/coco/images/val2017",
                         annotation_path="/home/wrc/wangchao/coco/annotations/instances_val2017.json",
                         use_crowd=False,
                         augments=False,
                         debug=False,
                         remove_blank=False,
...
def write_coco_json():
    ...
    img_root = "/home/wrc/wangchao/coco/images/val2017"
    model = FCOS()
    weights = torch.load("weights/focs_best_map.pth")['ema']
    model.load_state_dict(weights)
    model.cuda().eval()

    basic_transform = ScalePadding(target_size=(768, 768), padding_val=(103, 116, 123))
    coco = COCO("/home/wrc/wangchao/coco/annotations/instances_val2017.json")
...
def coco_eval():
    ...
    cocoGt = COCO("/home/wrc/wangchao/coco/annotations/instances_val2017.json")  # initialize COCO ground truth api
